...
module.exports = {
    ...
    async execute(interaction, client) {
        const embed = new EmbedBuilder()
            ...
            // .setThumbnail('https://cdn.discordapp.com/attachments/1014321307556524142/1040426113224159243/Zana_a_close-up_shot_of_a_fox_with_pink_pelt_sunbathing_in_the__f14a31a2-1ff7-4eb4-aeb5-e9823c98cf07.png')
            ...
            .addFields([
                {
                    ...
                    value: `Qualitative Research specialist | Innovation | Design Research | Previous lead Design Researcher of Peru's Prime Minister's Secretariat of Digital Government | Private Sector Healthcare Digital Transformation Researcher`,
                    inline: true,
                },
                {
